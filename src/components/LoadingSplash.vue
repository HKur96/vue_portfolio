    ...
    >
      ...
      <div class="relative text-center">
        <div class="relative inline-block mb-8">
          <div class="absolute inset-0 bg-gradient-to-br from-primary via-accent to-secondary rounded-full blur-2xl opacity-50 animate-pulse"></div>
          <div class="relative w-32 h-32 rounded-full bg-gradient-to-br from-primary to-accent p-1 shadow-glow-lg animate-spin" style="animation-duration: 3s;">
